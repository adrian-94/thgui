...
class MyPopup(QtGui.QDialog, pop.Ui_Dialog):
    def __init__(self):
...
class MainWindow(QtGui.QMainWindow,th_ui_2.Ui_MainWindow):
    ...
    def __init__(self): #constructor
        ...
        self.lineEdit_6.textChanged.connect(self.popit)
        self.pushButton_9.clicked.connect(self.select_multiple)
        self.pushButton_10.clicked.connect(self.select_multiple)
    #    self.lineEdit_4.textChanged.connect(self.popit)
    ...
    def select_multiple(self):
        ...
        m_1=QFileDialog.getOpenFileNames(None, caption, directory, filter_mask)
        for p in m_1:
    ...
    def popit(self):
        try:
            directory=os.path.join(R8,str(self.lineEdit_4.text()))
            #print directory
        except OSError:
             print "select work folder"
    ...
    def select_folder_3(self)  :
        ...
        """
        directory=os.path.join(R8,str(self.lineEdit_4.text()))#pop-up invoked
        if os.path.exists(directory):
           self.connect.(self.popit)
        """                                        
    def single_end(self):
        self.label_5.hide()
