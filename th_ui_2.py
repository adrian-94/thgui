...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(50, 50, 911, 421))
        ...
        self.gridLayout.addWidget(self.textEdit_2, 5, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.textEdit_3, 6, 6, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "mm10", None))
        self.comboBox.setItemText(1, _translate("MainWindow", "saccer3", None))
