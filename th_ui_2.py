...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(20, 40, 1321, 821))
        ...
        self.gridLayout.addWidget(self.label_7, 7, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_5, 7, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.listWidget, 7, 3, 1, 1)
        self.pushButton_4 = QtGui.QPushButton(self.gridLayoutWidget)
        self.pushButton_4.setObjectName(_fromUtf8("pushButton_4"))
        self.gridLayout.addWidget(self.pushButton_4, 7, 5, 1, 1)
        ...
        self.textEdit_2.setMaximumSize(QtCore.QSize(180, 180))
        self.textEdit_2.setObjectName(_fromUtf8("textEdit_2"))
        self.gridLayout.addWidget(self.textEdit_2, 6, 3, 1, 1)
        self.textEdit_3 = QtGui.QTextEdit(self.gridLayoutWidget)
        self.textEdit_3.setMaximumSize(QtCore.QSize(180, 180))
        ...
        self.gridLayout.addWidget(self.pushButton_10, 6, 5, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Select Single File", None))
        self.pushButton_2.setText(_translate("MainWindow", "Select Single File", None))
        self.label_5.setText(_translate("MainWindow", "R2 Files", None))
        self.pushButton_8.setText(_translate("MainWindow", "Select DNA Database Folder", None))
        self.radioButton.setText(_translate("MainWindow", "Single End", None))
        self.radioButton_2.setText(_translate("MainWindow", "Paired End", None))
        ...
        self.pushButton_9.setText(_translate("MainWindow", "Select Multiple Files", None))
        self.pushButton_10.setText(_translate("MainWindow", "Select Multiple Files", None))
